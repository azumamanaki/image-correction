...
BUCKETS = [
    ...
    {
        "name": "添削用-書初",
        "input":    "/おうち書道/共有データ/【受講生】/【書初用　作品】/添削用/提出画像",
        "print":    "/おうち書道/共有データ/【受講生】/【書初用　作品】/添削用/添削用印刷未",
        "processed":"/おうち書道/共有データ/【受講生】/【書初用　作品】/添削用/補正済元画像",
        "failed":   "/おうち書道/共有データ/【受講生】/【書初用　作品】/添削用/処理失敗",
        "target_px": (1093, 3071),  # (横, 縦) ≒ 92.5mm×260mm @300dpi
    },
    {
        "name": "清書用-書初",
        "input":    "/おうち書道/共有データ/【受講生】/【書初用　作品】/清書用/提出画像",
        "print":    "/おうち書道/共有データ/【受講生】/【書初用　作品】/清書用/清書用印刷未",
        "processed":"/おうち書道/共有データ/【受講生】/【書初用　作品】/清書用/補正済元画像",
        "failed":   "/おうち書道/共有データ/【受講生】/【書初用　作品】/清書用/処理失敗",
        "target_px": (1093, 3071),  # (横, 縦) ≒ 92.5mm×260mm @300dpi
    },
]
