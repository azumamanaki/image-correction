...
BUCKETS = [
    ...
    {
        "name": "清書用-書初",
        "input":    "/おうち書道/共有データ/【受講生】/【清書用　作品（出品用）】/書初/提出画像",
        "print":    "/おうち書道/共有データ/【受講生】/【清書用　作品（出品用）】/書初/清書用印刷未",
        "processed":"/おうち書道/共有データ/【受講生】/【清書用　作品（出品用）】/書初/補正済元画像",
        "failed":   "/おうち書道/共有データ/【受講生】/【清書用　作品（出品用）】/書初/処理失敗",
